...
extern touchgfx::GeneratedFont& getFont_SISER06_10_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_verdana_16_4bpp()),
    &(getFont_verdana_40_4bpp()),
    &(getFont_SISER06_10_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_verdana_16_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_verdana_40_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_SISER06_10_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
